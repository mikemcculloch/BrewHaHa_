 ...
 */
public class IngredientGrainVo {
    ...
    public IngredientGrainVo() {
    }

    public IngredientGrainVo(double amount, int countryPk, int grainPk, int grainUsePk, String hexColor, int ingredientGrainPk, String name, int unitOfMeasurePk, double color) {
        Amount = amount;
        CountryPk = countryPk;
        GrainPk = grainPk;
